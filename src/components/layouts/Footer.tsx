...
export default function Footer(props: { className?: string }) {
    return (
        <div className={cn('w-full flex justify-center text-sm border-t border-very-light-hover bg-background/50', props.className)}>
            <div className="m-8 flex w-full max-w-[600px] flex-col justify-center gap-5 p-6 sm:max-w-[700px]">
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex h-min flex-col justify-center">
                        ...
                        <p className="text-inactive">Skin in the game</p>
                    </div>
                </div>
