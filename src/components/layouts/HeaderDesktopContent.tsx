...
export default function HeaderDesktopContent() {
    return (
        <div className="relative hidden h-[70px] w-full max-w-[800px] animate-fade-down items-center justify-between gap-0.5 border-b border-light-hover pl-3 pr-2 backdrop-blur-md md:mt-3 md:flex md:h-fit md:justify-between md:rounded-3xl md:border-2 md:bg-transparent md:px-3 md:py-2.5">
