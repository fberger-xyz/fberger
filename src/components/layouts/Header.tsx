...
export default function Header(props: { className?: string }) {
    return (
        <div className={cn('fixed top-0 flex justify-center 45-center w-full', props.className)}>
            <div className="relative flex h-[70px] w-full max-w-[800px] items-center justify-between gap-0.5 border-b border-very-light-hover bg-background pl-3 pr-2 backdrop-blur-md sm:mt-2 sm:h-fit sm:justify-between sm:rounded-lg sm:border-transparent sm:bg-transparent sm:px-3 sm:py-2 md:px-4">
                ...
                <LinkWrapper href="/" className="hidden items-center gap-3 md:z-50 md:flex">
                    ...
                    <p className="mb-1 hidden text-2xl text-primary md:flex lg:font-bold">{APP_METADATA.SITE_NAME}</p>
                </LinkWrapper>
