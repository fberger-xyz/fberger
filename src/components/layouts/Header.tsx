...
export default function Header(props: { className?: string }) {
    return (
        <div className={cn('fixed top-0 flex justify-center z-50 w-full', props.className)}>
            <div className="relative flex h-[70px] w-full max-w-[800px] items-center justify-between gap-0.5 border-b border-very-light-hover pl-3 pr-2 shadow-sm backdrop-blur-md md:mt-3 md:h-fit md:justify-between md:rounded-3xl md:border md:border-light-hover md:bg-transparent md:px-3 md:py-2.5">
